Pod::Spec.new do |s|
  ...
  s.license               = { :type => 'MIT', :file => 'RepliesSDK/RepliesSDK.framework/Resources/License.md' }
  s.author                = { 'Replies Team' => 'support@replies.io' }
                          
  s.source                = { :http => 'http://sdkmacos.replies.io/releases/RepliesSDK-macOS-0.2.1.zip' }
  s.platform              = :osx
